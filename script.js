...
async function getMyGoblins() {
  goblinContract.methods.balanceOf(selectedAccount).call((err, result) => { 
    if(result > 0) {
      document.querySelector("#btn-mint").setAttribute("disabled","disabled");
    }
